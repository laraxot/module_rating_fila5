...
- [FALSE_FRIENDS](./FALSE_FRIENDS.md)
- [LICENSE](./LICENSE.md)
- [METODI_DUPLICATI_ANALISI](./METODI_DUPLICATI_ANALISI.md)
- [MIGRATIONS](./MIGRATIONS.md)
- [ON-DEMAND-PATTERN](./ON-DEMAND-PATTERN.md)
- [PERFORMANCE-OPTIMIZATION](./PERFORMANCE-OPTIMIZATION.md)
- [PRODUCT_LAUNCH_PLAN](./PRODUCT_LAUNCH_PLAN.md)
...
- [contracts-naming](./contracts-naming.md)
- [copilot-redundancy-audit-2026-05-25](./copilot-redundancy-audit-2026-05-25.md)
- [copilot-redundancy-audit](./copilot-redundancy-audit.md)
- [core-functionality](./core-functionality.md)
- [cyclomatic-complexity-report](./cyclomatic-complexity-report.md)
- [data-models](./data-models.md)
- [dataobjects-archived-duplicate](./dataobjects-archived-duplicate.md)
...
- [duplicate_methods](./duplicate_methods.md)
...
- [phpstan-errors-roadmap](./phpstan-errors-roadmap.md)
- [phpstan-fixes-2026-01](./phpstan-fixes-2026-01.md)
- [phpstan-fixes-analysis](./phpstan-fixes-analysis.md)
...
- [rating-architecture](./rating-architecture.md)
...
- [schema](./schema.md)
- [schemaless-attributes-errors](./schemaless-attributes-errors.md)
...
- [license](archived/license.md)

## llm-wiki

- [AGENTS](llm-wiki/AGENTS.md)
- [agents](llm-wiki/agents.md)
...
- [changelog-1](raw/root-import/changelog-1.md)
- [changelog-2](raw/root-import/changelog-2.md)
- [changelog](raw/root-import/changelog.md)
- [license-1](raw/root-import/license-1.md)
- [license](raw/root-import/license.md)

## roadmap

- [README](roadmap/README.md)
- [acceptance-criteria](roadmap/acceptance-criteria.md)
- [dependencies](roadmap/dependencies.md)
- [metrics](roadmap/metrics.md)
- [phases](roadmap/phases.md)
- [quality](roadmap/quality.md)
- [vision](roadmap/vision.md)

## root-md-files

- [changelog](root-md-files/changelog.md)
- [license](root-md-files/license.md)
...
- [INDEX](wiki/commands/INDEX.md)

## wiki/concepts

- [INDEX](wiki/concepts/INDEX.md)
- [composer-root-minimal-nwidart](wiki/concepts/composer-root-minimal-nwidart.md)
- [context-mode-rating-discipline](wiki/concepts/context-mode-rating-discipline.md)
- [context-overflow-prevention](wiki/concepts/context-overflow-prevention.md)
- [filament-resource-zen-pattern](wiki/concepts/filament-resource-zen-pattern.md)
- [method-name-homonyms](wiki/concepts/method-name-homonyms.md)
- [organizzativa-money](wiki/concepts/organizzativa-money.md)
- [phpstan-compliance](wiki/concepts/phpstan-compliance.md)
- [ponytail-audit](wiki/concepts/ponytail-audit.md)
- [second-brain-local-discipline](wiki/concepts/second-brain-local-discipline.md)
- [testing](wiki/concepts/testing.md)
- [visual-testing-playwright-puppeteer](wiki/concepts/visual-testing-playwright-puppeteer.md)
- [xotbase-table-columns-enforcement](wiki/concepts/xotbase-table-columns-enforcement.md)

## wiki/memories

- [INDEX](wiki/memories/INDEX.md)

## wiki/redundancy

- [duplicate-ratings-table-migrations](wiki/redundancy/duplicate-ratings-table-migrations.md)

## wiki/rules

- [INDEX](wiki/rules/INDEX.md)
- [no-rm-no-archive-use-old-suffix](wiki/rules/no-rm-no-archive-use-old-suffix.md)

## wiki/skills

- [INDEX](wiki/skills/INDEX.md)
