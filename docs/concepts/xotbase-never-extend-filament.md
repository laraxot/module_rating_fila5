...
type: concept
module: Rating
tags: [rating, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Rating filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/Rating` estende una classe `Filament\...` direttamente.
