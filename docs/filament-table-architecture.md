...
module: Rating
updated: 2026-09-01
qmd: "tabella filament resource table class getTableFilters XotBaseResourceTable HasXotTable list page rating"
---
...
```php
namespace Modules\Rating\Filament\Resources\FooResource\Tables;
