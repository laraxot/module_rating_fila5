# Graph Report - Rating  (2026-08-19)

## Corpus Check
- 289 files · ~61,662 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1818 nodes · 1940 edges · 189 communities (167 shown, 22 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `92b8a2f4`
...
3. `Rating` - 11 edges
4. `RatingMorph` - 11 edges
5. `Rating Module - FAQ` - 11 edges
6. `Rating {{TYPE^}} LLM Wiki Agent Instructions` - 11 edges
7. `Rating {{TYPE^}} LLM Wiki Agent Instructions` - 11 edges
8. `Rating Module LLM Wiki` - 11 edges
9. `RatingMorphPolicy` - 10 edges
10. `Rating Module` - 10 edges

## Surprising Connections (you probably didn't know these)
- `ratingObjectives()` --calls--> `Rating`  [INFERRED]
  app/Models/Traits/HasRatingsTrait.php → app/Models/Rating.php
- `ratings()` --calls--> `Rating`  [INFERRED]
  app/Models/Traits/HasRatingsTrait.php → app/Models/Rating.php
- `syncRatingsWhere()` --calls--> `Rating`  [INFERRED]
  app/Models/Traits/HasRatingsTrait.php → app/Models/Rating.php
- `getBettingUsers()` --calls--> `RatingMorph`  [INFERRED]
  app/Models/Traits/HasRating.php → app/Models/RatingMorph.php
- `ListRatings` --inherits--> `BaseListRatings`  [EXTRACTED]
  app/Filament/Resources/RatingResource/Pages/ListRatings.php → app/Filament/Resources/RatingResource/Pages/BaseListRatings.php
...
### Community 0 - "TestCase.php"
Cohesion: 0.06
Nodes (27): self, RatingData, self, RatingData, Rating, bootHasLikes(), dislikedBy(), isLikedBy() (+19 more)

### Community 1 - "HasRatingsTrait.php"
Cohesion: 0.07
Nodes (26): GetCountByModelRatingIdAction, GetRatingOptsByModelAction, GetSumByModelRatingIdAction, StatsOverview, StatsOverview, ratings(), getMyRatingAttribute(), getRatingsRules() (+18 more)

### Community 2 - "RatingFilamentSchemaTest.php"
Cohesion: 0.06
Nodes (18): BetTableAction, RatingMorphForm, RatingMorphInfolist, RatingMorphsTable, RatingMorphTable, BaseRatingForm, BaseRatingInfolist, RatingForm (+10 more)
...
Cohesion: 0.09
Nodes (21): dislikedBy(), isLikedBy(), likedBy(), RatingMorphPolicy, RatingPolicy, Rating, RatingMorph, getArrayRatingsWithImage() (+13 more)
...
### Community 8 - "RatingResource.php"
Cohesion: 0.07
Nodes (17): BaseRatingMorphResource, BaseRatingResource, CreateRatingMorph, EditRatingMorph, ListRatingMorphs, RatingMorphResource, BaseCreateRating, BaseEditRating (+9 more)

### Community 9 - "BaseRating"
Cohesion: 0.07
Nodes (20): AbstractRatingsHost, BaseModel, BaseMorphPivot, BaseRating, BaseRatingMorph, RatingFactory, Illuminate\Database\Eloquent\Factories\Factory, Illuminate\Database\Eloquent\Relations\BelongsTo (+12 more)
...
Cohesion: 0.12
Nodes (16): 1. Calculation Errors, 2. Sync Issues, 3. Audit Trail Failures, 4. Permission Errors, 5. Duplicate Ratings, 6. Category Conflicts, Error Categories, Error Pattern: "Audit log missing — no record of who rated" (+8 more)
...
Cohesion: 0.18
Nodes (8): Dipendenze e confini del modulo Rating, Dipendenze in ingresso (il Rating dipende da), Dipendenze in uscita (chi usa il Rating), Rischio dipendenze circolari, Versioni minime (riferimento), Need Help?, Quick Reference, Troubleshooting – Rating
...
Cohesion: 0.20
Nodes (9): Cosa non è testabile a unit, Coverage, Eseguire la suite, Helper dei test, Lacune trovate, non colmate, Rating — test e coverage, Skip condizionato, non skip permanente, Traduzioni (+1 more)
...
### Community 68 - "code-quality-analysis.md"
Cohesion: 0.22
Nodes (4): Product Roadmap - Rating Module, Q1 2026: Foundation, 🗓️ Timeline, 🎯 Vision & Strategy
...
### Community 73 - "Filament\Resources\RelationManagers\RelationManager"
Cohesion: 0.43
Nodes (4): RatingsRelationManager, RatingsRelationManager, Filament\Resources\RelationManagers\RelationManager, Filament\Tables\Table
...
- **Why does `Rating Module - FAQ` connect `Rating Module - FAQ` to `code-quality-analysis.md`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Are the 4 inferred relationships involving `Rating` (e.g. with `myRatings()` and `ratingObjectives()`) actually correct?**
  _`Rating` has 4 INFERRED edges - model-reasoned connections that need verification._
...
- **Should `HasRatingsTrait.php` be split into smaller, more focused modules?**
  _Cohesion score 0.06802721088435375 - nodes in this community are weakly interconnected._
- **Should `RatingFilamentSchemaTest.php` be split into smaller, more focused modules?**
